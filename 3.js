...
/**
 * Функция возвращает количество единиц, десятков и сотен в переданном
 * числе в виде объекта.
 * @param {number} userNumber - целое число от 0 до 999
 * @returns {object} - Объект с тремя свойствами, или пустой объект, 
 * в случае ошибки.
 */
